...
var import_stable = require("./stable.js");
...
function useMachine(machine, userProps = {}) {
  ...
  const ctx = (0, import_stable.useConst)(() => ({
    get(key) {
  ...
  const send = (0, import_stable.useStableFn)((event) => {
    queueMicrotask(() => {
  ...
  const computed = (0, import_stable.useStableFn)((key) => {
  ...
  const getStatus = (0, import_stable.useStableFn)(() => statusRef.current);
...
function useProp(value) {
  ...
  return (0, import_stable.useStableFn)(function get(key) {
